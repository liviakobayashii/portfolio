  ...
  return (
    <>
      <div className="flex flex-col gap-4 w-6xl">
        ...
        <h2 className="text-4xl bg-gradient-to-r from-fuchsia-300 via-fuchsia-500 to-fuchsia-800 bg-clip-text text-transparent font-bold pb-2">
          Front-end developer | UI/UX Designer
        </h2>
        <hr className="" />
      </div>
      <div className="flex flex-col gap-6 w-6xl ">
        <p className="text-justify text-xl text-neutral-200/70">

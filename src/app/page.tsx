    ...
    <>
      {linkWhatsapp && (
        <Link href={linkWhatsapp.href} target="_blank">
          <button className="bg-[#59D264] rounded-full p-3 fixed bottom-0 right-0 m-5 animate-bounce hover:cursor-pointer hover:bg-[#4ead55] duration-200">
      ...
      <section className="flex flex-col gap-6 py-30 bg-radial from-[#242424] via-[#1c1c1c] to-[#161616] lg:justify-center lg:items-center">
        <AboutMe />
      </section>
